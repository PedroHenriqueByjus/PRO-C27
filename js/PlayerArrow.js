class PlayerArrow {
  ...
  /* remove(index) {
    ...
    delete playerArrows[index];xxxxxxxxxxxxxxxxxxxxxxxxxx
  } */
  ...
  /* remove(index) {
    ...
    delete playerArrows[index];xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
  } */

  /* remove(index) {
    this.isRemoved = true;
    Matter.World.remove(world, this.body);
    delete playerArrows[];xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
  } */
